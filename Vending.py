class VendingMachine:
    ...
    def __init__(self, inventory, serial, days_until_maintenance):
        self.inventory = inventory  # dictionary with {<snack>: <amount>} as
        # key-value pairs. Possible snacks: candy, soda, chips, cookies. Keys
        # written in lowercase.
        self.revenue = 0  # Initially, when an instance of the vending
        # machine is created, the revenue is 0 and it's updated with each sale.
        self.serial = serial
    ...
    def sales_menu(self):
        ...
        while True:
            ...
            self.process_sale(
                list(self.inventory.keys())[cust_input - 1].lower())
            answer = int(input(
    ...
    # Method that processes the sale by asking the user how many snacks of
    # that type
    ...
    def process_sale(self, option):  # option must be in lowercase
        ...
        if self.inventory[option] > 0:
            ...
            if num_items <= self.inventory[option]:
                ...
                # Display a message confirming the purchase and current
                # inventory
    ...
    def find_snack_price(self, snack):
        ...
        # Method that prints a message with the total revenue of the instance
        # of VendingMachine
...
class HospitalVendingMachine(VendingMachine):
    ...
    def print_days_until_maintenance(self):
        print(
            "Number of days remaining for the machine to go for maintenance: ",
            self.days_until_maintenance)
